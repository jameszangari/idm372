...
module.exports = {
    init: function () {
        ...
        function addGeneralData(el, data) {
            ...
            (data.pp_0 && data.pp_0.includes('shuffle')) ? el.querySelector('.js-pp_0').style = `background-image: url(${data.pp_0});` : el.querySelector('.js-pp_0').style = '';
        ...
        function displayUser(user) {
            ...
            for (i = 1; i < 4; i++) {
                ...
                if (image) {
                    ...
                    (!!link && link.includes('shuffle')) ? image.style = `background-image: url(${link});` : image.style = '';
                }
            }
